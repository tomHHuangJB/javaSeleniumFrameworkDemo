...
JENKINS_URL="http://localhost:9081"  # Update if your Jenkins runs elsewhere.
JOB_NAME="java-selenium-ci"          # Update to your Jenkins job name.
USER="your-user"                     # Update with your Jenkins username.
TOKEN="your-api-token"               # Update with your Jenkins API token.
